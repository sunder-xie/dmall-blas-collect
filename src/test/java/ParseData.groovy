/**
 * Created by lrkin on 2017/5/25.
 */
class ParseData {
    static def parseData() {
    ...
    static def parseHeaders(HashMap map, String headerJson) {
    ...
    static def parseParam(HashMap map,String paramStr){
